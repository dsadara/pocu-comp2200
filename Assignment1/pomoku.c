...
size_t s_left_diagonal_score_before_black;
size_t s_left_diagonal_score_before_white;
size_t s_right_diagonal_score_before_black;
size_t s_right_diagonal_score_before_white;
...
int place_stone(const color_t color, const size_t row, const size_t col)
{
    ...
    if(color == COLOR_BLACK) {
        ...
        if (left_diagonal_score_temp != s_left_diagonal_score_before_black) {
            s_left_diagonal_score_before_black = left_diagonal_score_temp;
            g_player0_score += s_left_diagonal_score_before_black;
        }

        right_diagonal_score_temp = count_right_diagonal_chain_score(COLOR_BLACK, row, col);
        if (right_diagonal_score_temp != s_right_diagonal_score_before_black) {
            s_right_diagonal_score_before_black = right_diagonal_score_temp;
            g_player0_score += s_right_diagonal_score_before_black;
        }
        ...
        if (left_diagonal_score_temp != s_left_diagonal_score_before_white) {
            s_left_diagonal_score_before_white = left_diagonal_score_temp;
            g_player1_score += s_left_diagonal_score_before_white;
        }

        right_diagonal_score_temp = count_right_diagonal_chain_score(COLOR_WHITE, row, col);
        if (right_diagonal_score_temp != s_right_diagonal_score_before_white) {
            s_right_diagonal_score_before_white = right_diagonal_score_temp;
            g_player1_score += s_right_diagonal_score_before_white;
        }
    }
    return TRUE;
}
